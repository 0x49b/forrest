    ...
    return (
        <div className="bg-white rounded-lg border border-slate-200 shadow-sm p-8">
            <div className="text-center mb-8">
                ...
                <h2 className="text-2xl font-semibold text-slate-900 mb-2">Analyze Your Package
                    Dependencies</h2>
                <p className="text-slate-600">Paste your package.json content to visualize the
                    dependency tree</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div
                    ...
                    <div>
                        <h3 className="text-sm font-medium text-slate-700">Development
                            Dependencies</h3>
                        <p className="text-xs text-slate-500 mt-1">Include devDependencies in the
                            analysis</p>
                    </div>
